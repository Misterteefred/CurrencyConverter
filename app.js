...
function creerListe(){
    ...
    .then(result => { 
        ...
        Object.keys(liste).forEach(codeMonnaie => {
            ...
            elLiFrom.style.listStyleImage = `url(./drapeaux/${codeMonnaie.toLowerCase()}.jpg)`; 
            ...
            elLiTo.style.listStyleImage = `url(./drapeaux/${codeMonnaie.toLowerCase()}.jpg)`;
    ...
    if (valInput !== ''){            
        ...
        .then(result => { 
            ...
            tabCodeMonnaieTrouve.forEach(code=>{  
                ...
                elLi.style.listStyleImage = `url(./drapeaux/${code.toLowerCase()}.jpg)`;
